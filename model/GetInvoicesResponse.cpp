...
void GetInvoicesResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetInvoicesResponse::toJson() const
{
...
void GetInvoicesResponse::fromJson(web::json::value& val)
{
...
void GetInvoicesResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void GetInvoicesResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t GetInvoicesResponse::getPage() const
{
    return m_Page;
}


void GetInvoicesResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t GetInvoicesResponse::getPageCount() const
{
    return m_PageCount;
}


void GetInvoicesResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t GetInvoicesResponse::getLimit() const
{
    return m_Limit;
}


void GetInvoicesResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<Invoice>>& GetInvoicesResponse::getResources()
{
    return m_Resources;
}

void GetInvoicesResponse::setResources(std::vector<std::shared_ptr<Invoice>> value)
{
    m_Resources = value;
