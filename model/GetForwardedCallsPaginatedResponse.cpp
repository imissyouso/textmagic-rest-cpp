...
void GetForwardedCallsPaginatedResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetForwardedCallsPaginatedResponse::toJson() const
{
...
void GetForwardedCallsPaginatedResponse::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[utility::conversions::to_string_t("resources")].as_array() )
        {
            if(item.is_null())
            {
                m_Resources.push_back( std::shared_ptr<ForwardedCall>(nullptr) );
            }
            else
            {
                std::shared_ptr<ForwardedCall> newItem(new ForwardedCall());
...
void GetForwardedCallsPaginatedResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void GetForwardedCallsPaginatedResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t GetForwardedCallsPaginatedResponse::getPage() const
{
    return m_Page;
}


void GetForwardedCallsPaginatedResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t GetForwardedCallsPaginatedResponse::getPageCount() const
{
    return m_PageCount;
}


void GetForwardedCallsPaginatedResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t GetForwardedCallsPaginatedResponse::getLimit() const
{
    return m_Limit;
}


void GetForwardedCallsPaginatedResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<ForwardedCall>>& GetForwardedCallsPaginatedResponse::getResources()
{
    return m_Resources;
}

void GetForwardedCallsPaginatedResponse::setResources(std::vector<std::shared_ptr<ForwardedCall>> value)
{
    m_Resources = value;
