...
void SearchContactsResponse::validate()
{
    // TODO: implement validation
}

web::json::value SearchContactsResponse::toJson() const
{
...
void SearchContactsResponse::fromJson(web::json::value& val)
{
...
void SearchContactsResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void SearchContactsResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t SearchContactsResponse::getPage() const
{
    return m_Page;
}


void SearchContactsResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t SearchContactsResponse::getPageCount() const
{
    return m_PageCount;
}


void SearchContactsResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t SearchContactsResponse::getLimit() const
{
    return m_Limit;
}


void SearchContactsResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<Contact>>& SearchContactsResponse::getResources()
{
    return m_Resources;
}

void SearchContactsResponse::setResources(std::vector<std::shared_ptr<Contact>> value)
{
    m_Resources = value;
