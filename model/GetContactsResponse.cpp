...
void GetContactsResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetContactsResponse::toJson() const
{
...
void GetContactsResponse::fromJson(web::json::value& val)
{
...
void GetContactsResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void GetContactsResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t GetContactsResponse::getPage() const
{
    return m_Page;
}


void GetContactsResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t GetContactsResponse::getPageCount() const
{
    return m_PageCount;
}


void GetContactsResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t GetContactsResponse::getLimit() const
{
    return m_Limit;
}


void GetContactsResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<Contact>>& GetContactsResponse::getResources()
{
    return m_Resources;
}

void GetContactsResponse::setResources(std::vector<std::shared_ptr<Contact>> value)
{
    m_Resources = value;
