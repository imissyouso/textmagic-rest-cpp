...
void GetFavouritesResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetFavouritesResponse::toJson() const
{
...
void GetFavouritesResponse::fromJson(web::json::value& val)
{
...
void GetFavouritesResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void GetFavouritesResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t GetFavouritesResponse::getPage() const
{
    return m_Page;
}


void GetFavouritesResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t GetFavouritesResponse::getPageCount() const
{
    return m_PageCount;
}


void GetFavouritesResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t GetFavouritesResponse::getLimit() const
{
    return m_Limit;
}


void GetFavouritesResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<FavoriteContact>>& GetFavouritesResponse::getResources()
{
    return m_Resources;
}

void GetFavouritesResponse::setResources(std::vector<std::shared_ptr<FavoriteContact>> value)
{
    m_Resources = value;
