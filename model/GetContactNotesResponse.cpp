...
void GetContactNotesResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetContactNotesResponse::toJson() const
{
...
void GetContactNotesResponse::fromJson(web::json::value& val)
{
...
void GetContactNotesResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void GetContactNotesResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t GetContactNotesResponse::getPage() const
{
    return m_Page;
}


void GetContactNotesResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t GetContactNotesResponse::getPageCount() const
{
    return m_PageCount;
}


void GetContactNotesResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t GetContactNotesResponse::getLimit() const
{
    return m_Limit;
}


void GetContactNotesResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<ContactNote>>& GetContactNotesResponse::getResources()
{
    return m_Resources;
}

void GetContactNotesResponse::setResources(std::vector<std::shared_ptr<ContactNote>> value)
{
    m_Resources = value;
