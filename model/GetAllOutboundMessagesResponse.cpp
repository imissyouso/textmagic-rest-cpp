...
void GetAllOutboundMessagesResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetAllOutboundMessagesResponse::toJson() const
{
...
void GetAllOutboundMessagesResponse::fromJson(web::json::value& val)
{
...
void GetAllOutboundMessagesResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void GetAllOutboundMessagesResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t GetAllOutboundMessagesResponse::getPage() const
{
    return m_Page;
}


void GetAllOutboundMessagesResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t GetAllOutboundMessagesResponse::getPageCount() const
{
    return m_PageCount;
}


void GetAllOutboundMessagesResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t GetAllOutboundMessagesResponse::getLimit() const
{
    return m_Limit;
}


void GetAllOutboundMessagesResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<MessageOut>>& GetAllOutboundMessagesResponse::getResources()
{
    return m_Resources;
}

void GetAllOutboundMessagesResponse::setResources(std::vector<std::shared_ptr<MessageOut>> value)
{
    m_Resources = value;
