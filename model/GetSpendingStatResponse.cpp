...
void GetSpendingStatResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetSpendingStatResponse::toJson() const
{
...
void GetSpendingStatResponse::fromJson(web::json::value& val)
{
...
void GetSpendingStatResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void GetSpendingStatResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t GetSpendingStatResponse::getPage() const
{
    return m_Page;
}


void GetSpendingStatResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t GetSpendingStatResponse::getPageCount() const
{
    return m_PageCount;
}


void GetSpendingStatResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t GetSpendingStatResponse::getLimit() const
{
    return m_Limit;
}


void GetSpendingStatResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<UserStatement>>& GetSpendingStatResponse::getResources()
{
    return m_Resources;
}

void GetSpendingStatResponse::setResources(std::vector<std::shared_ptr<UserStatement>> value)
{
    m_Resources = value;
