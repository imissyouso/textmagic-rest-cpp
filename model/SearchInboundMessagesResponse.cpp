...
void SearchInboundMessagesResponse::validate()
{
    // TODO: implement validation
}

web::json::value SearchInboundMessagesResponse::toJson() const
{
...
void SearchInboundMessagesResponse::fromJson(web::json::value& val)
{
...
void SearchInboundMessagesResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void SearchInboundMessagesResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t SearchInboundMessagesResponse::getPage() const
{
    return m_Page;
}


void SearchInboundMessagesResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t SearchInboundMessagesResponse::getPageCount() const
{
    return m_PageCount;
}


void SearchInboundMessagesResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t SearchInboundMessagesResponse::getLimit() const
{
    return m_Limit;
}


void SearchInboundMessagesResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<MessageIn>>& SearchInboundMessagesResponse::getResources()
{
    return m_Resources;
}

void SearchInboundMessagesResponse::setResources(std::vector<std::shared_ptr<MessageIn>> value)
{
    m_Resources = value;
