...
void GetUnsubscribersResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetUnsubscribersResponse::toJson() const
{
...
void GetUnsubscribersResponse::fromJson(web::json::value& val)
{
...
void GetUnsubscribersResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void GetUnsubscribersResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t GetUnsubscribersResponse::getPage() const
{
    return m_Page;
}


void GetUnsubscribersResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t GetUnsubscribersResponse::getPageCount() const
{
    return m_PageCount;
}


void GetUnsubscribersResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t GetUnsubscribersResponse::getLimit() const
{
    return m_Limit;
}


void GetUnsubscribersResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<UnsubscribedContact>>& GetUnsubscribersResponse::getResources()
{
    return m_Resources;
}

void GetUnsubscribersResponse::setResources(std::vector<std::shared_ptr<UnsubscribedContact>> value)
{
    m_Resources = value;
