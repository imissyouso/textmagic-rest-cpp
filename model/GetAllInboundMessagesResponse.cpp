...
void GetAllInboundMessagesResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetAllInboundMessagesResponse::toJson() const
{
...
void GetAllInboundMessagesResponse::fromJson(web::json::value& val)
{
...
void GetAllInboundMessagesResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void GetAllInboundMessagesResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t GetAllInboundMessagesResponse::getPage() const
{
    return m_Page;
}


void GetAllInboundMessagesResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t GetAllInboundMessagesResponse::getPageCount() const
{
    return m_PageCount;
}


void GetAllInboundMessagesResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t GetAllInboundMessagesResponse::getLimit() const
{
    return m_Limit;
}


void GetAllInboundMessagesResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<MessageIn>>& GetAllInboundMessagesResponse::getResources()
{
    return m_Resources;
}

void GetAllInboundMessagesResponse::setResources(std::vector<std::shared_ptr<MessageIn>> value)
{
    m_Resources = value;
