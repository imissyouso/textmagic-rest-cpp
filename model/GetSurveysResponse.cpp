...
void GetSurveysResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetSurveysResponse::toJson() const
{
...
void GetSurveysResponse::fromJson(web::json::value& val)
{
...
void GetSurveysResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void GetSurveysResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t GetSurveysResponse::getPage() const
{
    return m_Page;
}


void GetSurveysResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t GetSurveysResponse::getPageCount() const
{
    return m_PageCount;
}


void GetSurveysResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t GetSurveysResponse::getLimit() const
{
    return m_Limit;
}


void GetSurveysResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<Survey>>& GetSurveysResponse::getResources()
{
    return m_Resources;
}

void GetSurveysResponse::setResources(std::vector<std::shared_ptr<Survey>> value)
{
    m_Resources = value;
