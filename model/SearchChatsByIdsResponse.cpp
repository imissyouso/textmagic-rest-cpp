...
void SearchChatsByIdsResponse::validate()
{
    // TODO: implement validation
}

web::json::value SearchChatsByIdsResponse::toJson() const
{
...
void SearchChatsByIdsResponse::fromJson(web::json::value& val)
{
...
void SearchChatsByIdsResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void SearchChatsByIdsResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t SearchChatsByIdsResponse::getPage() const
{
    return m_Page;
}


void SearchChatsByIdsResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t SearchChatsByIdsResponse::getPageCount() const
{
    return m_PageCount;
}


void SearchChatsByIdsResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t SearchChatsByIdsResponse::getLimit() const
{
    return m_Limit;
}


void SearchChatsByIdsResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<Chat>>& SearchChatsByIdsResponse::getResources()
{
    return m_Resources;
}

void SearchChatsByIdsResponse::setResources(std::vector<std::shared_ptr<Chat>> value)
{
    m_Resources = value;
