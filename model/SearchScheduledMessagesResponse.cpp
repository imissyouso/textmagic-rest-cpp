...
void SearchScheduledMessagesResponse::validate()
{
    // TODO: implement validation
}

web::json::value SearchScheduledMessagesResponse::toJson() const
{
...
void SearchScheduledMessagesResponse::fromJson(web::json::value& val)
{
...
void SearchScheduledMessagesResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void SearchScheduledMessagesResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t SearchScheduledMessagesResponse::getPage() const
{
    return m_Page;
}


void SearchScheduledMessagesResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t SearchScheduledMessagesResponse::getPageCount() const
{
    return m_PageCount;
}


void SearchScheduledMessagesResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t SearchScheduledMessagesResponse::getLimit() const
{
    return m_Limit;
}


void SearchScheduledMessagesResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<MessagesIcs>>& SearchScheduledMessagesResponse::getResources()
{
    return m_Resources;
}

void SearchScheduledMessagesResponse::setResources(std::vector<std::shared_ptr<MessagesIcs>> value)
{
    m_Resources = value;
