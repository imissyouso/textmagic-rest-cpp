...
void SearchChatsByReceipentResponse::validate()
{
    // TODO: implement validation
}

web::json::value SearchChatsByReceipentResponse::toJson() const
{
...
void SearchChatsByReceipentResponse::fromJson(web::json::value& val)
{
...
void SearchChatsByReceipentResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void SearchChatsByReceipentResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t SearchChatsByReceipentResponse::getPage() const
{
    return m_Page;
}


void SearchChatsByReceipentResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t SearchChatsByReceipentResponse::getPageCount() const
{
    return m_PageCount;
}


void SearchChatsByReceipentResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t SearchChatsByReceipentResponse::getLimit() const
{
    return m_Limit;
}


void SearchChatsByReceipentResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<Chat>>& SearchChatsByReceipentResponse::getResources()
{
    return m_Resources;
}

void SearchChatsByReceipentResponse::setResources(std::vector<std::shared_ptr<Chat>> value)
{
    m_Resources = value;
