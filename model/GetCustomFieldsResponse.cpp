...
void GetCustomFieldsResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetCustomFieldsResponse::toJson() const
{
...
void GetCustomFieldsResponse::fromJson(web::json::value& val)
{
...
void GetCustomFieldsResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void GetCustomFieldsResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t GetCustomFieldsResponse::getPage() const
{
    return m_Page;
}


void GetCustomFieldsResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t GetCustomFieldsResponse::getPageCount() const
{
    return m_PageCount;
}


void GetCustomFieldsResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t GetCustomFieldsResponse::getLimit() const
{
    return m_Limit;
}


void GetCustomFieldsResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<UserCustomField>>& GetCustomFieldsResponse::getResources()
{
    return m_Resources;
}

void GetCustomFieldsResponse::setResources(std::vector<std::shared_ptr<UserCustomField>> value)
{
    m_Resources = value;
