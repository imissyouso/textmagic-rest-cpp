...
void GetUserDedicatedNumbersResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetUserDedicatedNumbersResponse::toJson() const
{
...
void GetUserDedicatedNumbersResponse::fromJson(web::json::value& val)
{
...
void GetUserDedicatedNumbersResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void GetUserDedicatedNumbersResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t GetUserDedicatedNumbersResponse::getPage() const
{
    return m_Page;
}


void GetUserDedicatedNumbersResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t GetUserDedicatedNumbersResponse::getPageCount() const
{
    return m_PageCount;
}


void GetUserDedicatedNumbersResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t GetUserDedicatedNumbersResponse::getLimit() const
{
    return m_Limit;
}


void GetUserDedicatedNumbersResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<UsersInbound>>& GetUserDedicatedNumbersResponse::getResources()
{
    return m_Resources;
}

void GetUserDedicatedNumbersResponse::setResources(std::vector<std::shared_ptr<UsersInbound>> value)
{
    m_Resources = value;
