...
void SearchOutboundMessagesResponse::validate()
{
    // TODO: implement validation
}

web::json::value SearchOutboundMessagesResponse::toJson() const
{
...
void SearchOutboundMessagesResponse::fromJson(web::json::value& val)
{
...
void SearchOutboundMessagesResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void SearchOutboundMessagesResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t SearchOutboundMessagesResponse::getPage() const
{
    return m_Page;
}


void SearchOutboundMessagesResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t SearchOutboundMessagesResponse::getPageCount() const
{
    return m_PageCount;
}


void SearchOutboundMessagesResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t SearchOutboundMessagesResponse::getLimit() const
{
    return m_Limit;
}


void SearchOutboundMessagesResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<MessageOut>>& SearchOutboundMessagesResponse::getResources()
{
    return m_Resources;
}

void SearchOutboundMessagesResponse::setResources(std::vector<std::shared_ptr<MessageOut>> value)
{
    m_Resources = value;
