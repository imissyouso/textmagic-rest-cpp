...
void GetUserListsResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetUserListsResponse::toJson() const
{
...
void GetUserListsResponse::fromJson(web::json::value& val)
{
...
void GetUserListsResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void GetUserListsResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t GetUserListsResponse::getPage() const
{
    return m_Page;
}


void GetUserListsResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t GetUserListsResponse::getPageCount() const
{
    return m_PageCount;
}


void GetUserListsResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t GetUserListsResponse::getLimit() const
{
    return m_Limit;
}


void GetUserListsResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<Group>>& GetUserListsResponse::getResources()
{
    return m_Resources;
}

void GetUserListsResponse::setResources(std::vector<std::shared_ptr<Group>> value)
{
    m_Resources = value;
