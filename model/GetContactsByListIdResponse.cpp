...
void GetContactsByListIdResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetContactsByListIdResponse::toJson() const
{
...
void GetContactsByListIdResponse::fromJson(web::json::value& val)
{
...
void GetContactsByListIdResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void GetContactsByListIdResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t GetContactsByListIdResponse::getPage() const
{
    return m_Page;
}


void GetContactsByListIdResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t GetContactsByListIdResponse::getPageCount() const
{
    return m_PageCount;
}


void GetContactsByListIdResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t GetContactsByListIdResponse::getLimit() const
{
    return m_Limit;
}


void GetContactsByListIdResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<Contact>>& GetContactsByListIdResponse::getResources()
{
    return m_Resources;
}

void GetContactsByListIdResponse::setResources(std::vector<std::shared_ptr<Contact>> value)
{
    m_Resources = value;
