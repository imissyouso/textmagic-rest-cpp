...
void GetAllScheduledMessagesResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetAllScheduledMessagesResponse::toJson() const
{
...
void GetAllScheduledMessagesResponse::fromJson(web::json::value& val)
{
...
void GetAllScheduledMessagesResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void GetAllScheduledMessagesResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t GetAllScheduledMessagesResponse::getPage() const
{
    return m_Page;
}


void GetAllScheduledMessagesResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t GetAllScheduledMessagesResponse::getPageCount() const
{
    return m_PageCount;
}


void GetAllScheduledMessagesResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t GetAllScheduledMessagesResponse::getLimit() const
{
    return m_Limit;
}


void GetAllScheduledMessagesResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<MessagesIcs>>& GetAllScheduledMessagesResponse::getResources()
{
    return m_Resources;
}

void GetAllScheduledMessagesResponse::setResources(std::vector<std::shared_ptr<MessagesIcs>> value)
{
    m_Resources = value;
