...
void GetAllChatsResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetAllChatsResponse::toJson() const
{
...
void GetAllChatsResponse::fromJson(web::json::value& val)
{
...
void GetAllChatsResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void GetAllChatsResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t GetAllChatsResponse::getPage() const
{
    return m_Page;
}


void GetAllChatsResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t GetAllChatsResponse::getPageCount() const
{
    return m_PageCount;
}


void GetAllChatsResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t GetAllChatsResponse::getLimit() const
{
    return m_Limit;
}


void GetAllChatsResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<Chat>>& GetAllChatsResponse::getResources()
{
    return m_Resources;
}

void GetAllChatsResponse::setResources(std::vector<std::shared_ptr<Chat>> value)
{
    m_Resources = value;
