...
std::shared_ptr<Object> UpdateContactInputObject::getCustomFieldValues() const
{
    return m_CustomFieldValues;
}


void UpdateContactInputObject::setCustomFieldValues(std::shared_ptr<Object> value)
{
