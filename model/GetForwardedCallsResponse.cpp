...
void GetForwardedCallsResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetForwardedCallsResponse::toJson() const
{
...
void GetForwardedCallsResponse::fromJson(web::json::value& val)
{
    setPage(ModelBase::int32_tFromJson(val[utility::conversions::to_string_t("page")]));
...
void GetForwardedCallsResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void GetForwardedCallsResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t GetForwardedCallsResponse::getPage() const
{
    return m_Page;
}


void GetForwardedCallsResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t GetForwardedCallsResponse::getPageCount() const
{
    return m_PageCount;
}


void GetForwardedCallsResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t GetForwardedCallsResponse::getLimit() const
{
    return m_Limit;
}


void GetForwardedCallsResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<ForwardedCall>>& GetForwardedCallsResponse::getResources()
{
    return m_Resources;
}

void GetForwardedCallsResponse::setResources(std::vector<std::shared_ptr<ForwardedCall>> value)
{
    m_Resources = value;
