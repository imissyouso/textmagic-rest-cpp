...
void SearchTemplatesResponse::validate()
{
    // TODO: implement validation
}

web::json::value SearchTemplatesResponse::toJson() const
{
...
void SearchTemplatesResponse::fromJson(web::json::value& val)
{
...
void SearchTemplatesResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void SearchTemplatesResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t SearchTemplatesResponse::getPage() const
{
    return m_Page;
}


void SearchTemplatesResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t SearchTemplatesResponse::getPageCount() const
{
    return m_PageCount;
}


void SearchTemplatesResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t SearchTemplatesResponse::getLimit() const
{
    return m_Limit;
}


void SearchTemplatesResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<MessageTemplate>>& SearchTemplatesResponse::getResources()
{
    return m_Resources;
}

void SearchTemplatesResponse::setResources(std::vector<std::shared_ptr<MessageTemplate>> value)
{
    m_Resources = value;
