...
void GetSenderIdsResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetSenderIdsResponse::toJson() const
{
...
void GetSenderIdsResponse::fromJson(web::json::value& val)
{
...
void GetSenderIdsResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void GetSenderIdsResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t GetSenderIdsResponse::getPage() const
{
    return m_Page;
}


void GetSenderIdsResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t GetSenderIdsResponse::getPageCount() const
{
    return m_PageCount;
}


void GetSenderIdsResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t GetSenderIdsResponse::getLimit() const
{
    return m_Limit;
}


void GetSenderIdsResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<SenderId>>& GetSenderIdsResponse::getResources()
{
    return m_Resources;
}

void GetSenderIdsResponse::setResources(std::vector<std::shared_ptr<SenderId>> value)
{
    m_Resources = value;
