...
void GetAllBulkSessionsResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetAllBulkSessionsResponse::toJson() const
{
...
void GetAllBulkSessionsResponse::fromJson(web::json::value& val)
{
...
void GetAllBulkSessionsResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void GetAllBulkSessionsResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t GetAllBulkSessionsResponse::getPage() const
{
    return m_Page;
}


void GetAllBulkSessionsResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t GetAllBulkSessionsResponse::getPageCount() const
{
    return m_PageCount;
}


void GetAllBulkSessionsResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t GetAllBulkSessionsResponse::getLimit() const
{
    return m_Limit;
}


void GetAllBulkSessionsResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<BulkSession>>& GetAllBulkSessionsResponse::getResources()
{
    return m_Resources;
}

void GetAllBulkSessionsResponse::setResources(std::vector<std::shared_ptr<BulkSession>> value)
{
    m_Resources = value;
