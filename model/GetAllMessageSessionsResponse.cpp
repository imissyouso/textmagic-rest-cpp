...
void GetAllMessageSessionsResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetAllMessageSessionsResponse::toJson() const
{
...
void GetAllMessageSessionsResponse::fromJson(web::json::value& val)
{
...
void GetAllMessageSessionsResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void GetAllMessageSessionsResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t GetAllMessageSessionsResponse::getPage() const
{
    return m_Page;
}


void GetAllMessageSessionsResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t GetAllMessageSessionsResponse::getPageCount() const
{
    return m_PageCount;
}


void GetAllMessageSessionsResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t GetAllMessageSessionsResponse::getLimit() const
{
    return m_Limit;
}


void GetAllMessageSessionsResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<MessageSession>>& GetAllMessageSessionsResponse::getResources()
{
    return m_Resources;
}

void GetAllMessageSessionsResponse::setResources(std::vector<std::shared_ptr<MessageSession>> value)
{
    m_Resources = value;
