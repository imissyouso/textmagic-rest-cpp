...
void GetAllTemplatesResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetAllTemplatesResponse::toJson() const
{
...
void GetAllTemplatesResponse::fromJson(web::json::value& val)
{
...
void GetAllTemplatesResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void GetAllTemplatesResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t GetAllTemplatesResponse::getPage() const
{
    return m_Page;
}


void GetAllTemplatesResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t GetAllTemplatesResponse::getPageCount() const
{
    return m_PageCount;
}


void GetAllTemplatesResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t GetAllTemplatesResponse::getLimit() const
{
    return m_Limit;
}


void GetAllTemplatesResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<MessageTemplate>>& GetAllTemplatesResponse::getResources()
{
    return m_Resources;
}

void GetAllTemplatesResponse::setResources(std::vector<std::shared_ptr<MessageTemplate>> value)
{
    m_Resources = value;
