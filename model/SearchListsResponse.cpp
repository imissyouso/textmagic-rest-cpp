...
void SearchListsResponse::validate()
{
    // TODO: implement validation
}

web::json::value SearchListsResponse::toJson() const
{
...
void SearchListsResponse::fromJson(web::json::value& val)
{
...
void SearchListsResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void SearchListsResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int32_t SearchListsResponse::getPage() const
{
    return m_Page;
}


void SearchListsResponse::setPage(int32_t value)
{
    m_Page = value;
    
}
int32_t SearchListsResponse::getPageCount() const
{
    return m_PageCount;
}


void SearchListsResponse::setPageCount(int32_t value)
{
    m_PageCount = value;
    
}
int32_t SearchListsResponse::getLimit() const
{
    return m_Limit;
}


void SearchListsResponse::setLimit(int32_t value)
{
    m_Limit = value;
    
}
std::vector<std::shared_ptr<Group>>& SearchListsResponse::getResources()
{
    return m_Resources;
}

void SearchListsResponse::setResources(std::vector<std::shared_ptr<Group>> value)
{
    m_Resources = value;
